...
function userChanged(user){
    ...
    var userNameInputElm = document.getElementById("authorName");
...
var updateSignIn = function() {
    ...
    if (sgnd) {
        ...
        document.getElementById("facebookLogin").classList.add("skryty");
...
function onSuccess(googleUser) {
    changeName(googleUser.getBasicProfile().getName());
